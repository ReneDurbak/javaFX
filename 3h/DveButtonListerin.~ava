...
public class DveButtonListerin extends Application{
  ...
  public void initGUI(Stage stage){
    ...
    btn_java.setOnAction(new ButtonClick());
    btn_javafx.setOnAction(new ButtonClick());
  ...
  class ButtonClick implements EventHandler{
    ...
    public void handle(Event event){
      ...
      if (event.getSource().equals(btn_java)) lb_text.setText("Mneow");
      else lb_text.setText("Hauf");
